export const ProgrammingLanguages = [
  ...
  { name: "Kotlin", link: "https://developer.android.com/kotlin" },
];
...
export const LibrariesAndFrameworks = [
  ...
  {
    name: "Cocoa Touch",
    link: "https://developer.apple.com/library/archive/documentation/General/Conceptual/DevPedia-CocoaCore/Cocoa.html",
  },
  {
    name: "SwiftUI",
