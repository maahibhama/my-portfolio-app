  ...
  return (
    <div className="wrapper">
      <div className="max-w-5xl mx-auto flex flex-col gap-4 items-center justify-center">
        ...
        <a href="mailto:maahibhama@gmail.com">
      ...
      <div className="mt-8 flex items-center flex-wrap   gap-8 justify-center">
        <SocialLink title="Github" link="https://github.com/maahibhama" />
        {/* <SocialLink title="Youtube" link="https://www.youtube.com/@reactjsBD" /> */}
        <SocialLink
          title="Linkedin"
          link="https://www.linkedin.com/in/mahendrabhama"
        />
        <SocialLink
          title="Facebook"
          link="https://www.facebook.com/maahibhama/"
        />
        <SocialLink title="Nextjs" link="https://vercel.com/maahibhama" />
      </div>
    </div>
  );
};
